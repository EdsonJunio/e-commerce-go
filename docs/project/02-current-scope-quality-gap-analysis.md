...
| ECOM-002.5 | done | `fix/ecom-002-5-category-hierarchy-cycles` | Independent review approved; PostgreSQL cycle and concurrency tests ran without skips; format, vet, tests, race, and build passed. OpenAPI drift was blocked; lint, secret, and vulnerability tools were unavailable. These limitations were explicitly accepted for this unit. Local branch only; no push or merge. | 2026-09-21 |
